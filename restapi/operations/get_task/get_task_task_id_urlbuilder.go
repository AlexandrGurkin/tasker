...
func (o *GetTaskTaskIDURL) Build() (*url.URL, error) {
	...
	if taskID != "" {
		...
		return nil, errors.New("taskId is required on GetTaskTaskIDURL")
	}
...
func (o *GetTaskTaskIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTaskTaskIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTaskTaskIDURL")
	}
