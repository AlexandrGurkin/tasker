...
// GetTaskTaskIDParams contains all the bound params for the get task task ID operation
...
func (o *GetTaskTaskIDParams) bindTaskID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
