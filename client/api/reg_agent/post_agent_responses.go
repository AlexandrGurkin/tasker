...
func (o *PostAgentNoContent) Error() string {
	return fmt.Sprintf("[POST /agent][%d] postAgentNoContent ", 204)
}

func (o *PostAgentNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
